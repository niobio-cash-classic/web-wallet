...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
    <h5 class="my-0 mr-md-auto font-weight-normal">Carteira NBR</h5>
...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    <h1 class="display-4">Seus nióbios seguros.</h1>
...
<div class="container">
    <div class="card-deck mb-3 text-center">
        <table class="table table-hover">
            ...
            <tr>
                <th scope="col">#</th>
                <th scope="col">Hash Transação</th>
            ...
            <tr>
                <th scope="row">1</th>
                <td>0438095840398fFDAKJFDSALJFDSLAKA</td>
                <td>10.44893939</td>
                <td>20/01/2018 14:00:00</td>
            </tr>
            <tr>
                <th scope="row">2</th>
                <td>0438095840398fFDAKJFDSALJFDSLAKA</td>
