...
! function(a) {
    ...
    e.common = {}, e.common.minChar = 6, e.common.usernameField = "#username", e.common.userInputs = [], e.common.onLoad = void 0, e.common.onKeyUp = void 0, e.common.zxcvbn = !1, e.common.zxcvbnTerms = [], e.common.debug = !1, e.rules = {}, e.rules.extra = {}, e.rules.scores = {
        ...
        wordLength: "Sua senha está pequena",
        wordNotEmail: "Não use seu email na sua senha",
        wordSimilarToUsername: "Sua senha não pode conter seu usuárioe",
        wordTwoCharacterClasses: "Use caracteres variados",
        wordRepetitions: "Existem muitas repetições",
        wordSequences: "Sua senha contém muita sequência"
    ...
    var options = {
        ...
        ui: {
            ...
            verdicts: [
                ...
                "<span class='fa fa-thumbs-up'></span> Excelente"
            ],
